  ...
  const members = [
    {
      ...
      photo:
        "https://i.ibb.co/0nZ6C2c/Anaavatar-aesthetic-illustration-569774-79.webp",
    ...
    <div className="mt-24">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-10 mt-12">
        {members.map((member, idx) => (
          <div
            key={idx}
            className="team-container shadow-lg mx-auto rounded-lg p-10"
          >
            <img src={member.photo} alt="Avatar" className="h-56 w-full" />
              ...
              <div className="text">
                <button className="mx-3 grid grid-cols-3 gap-3">
                  ...
                  <a href={member.portfolio} target="_blank">
                    {" "}
                    <FaPortrait className="text-2xl"></FaPortrait>
                  </a>

...
<div className='w-full bg-gray-100 mt-20 pt-10 absolute'>
  ...
  <div className="container mx-auto px-4">
    <div className="flex flex-wrap text-left lg:text-left">
      <div className="w-full lg:w-6/12 px-4">
        <h4 className="text-3xl fonat-semibold text-accent">Let's keep in touch!</h4>
        <h5 className="text-lg mt-0 mb-2 text-blueGray-600">
          Find us on any of these platforms, we respond 1-2 business days.
        </h5>
        <div className="mt-6 lg:mb-0 mb-6">
          <button className="bg-white text-lightBlue-400 shadow-lg font-normal h-10 w-10 items-center justify-center align-center rounded-full outline-none focus:outline-none mr-2" type="button">
            <FaFacebookF className="text-blue-600 w-full text-center text-xl"/></button>
            
            <button className="bg-white text-lightBlue-600 shadow-lg font-normal h-10 w-10 items-center justify-center align-center rounded-full outline-none focus:outline-none mr-2" type="button">
            <FaTwitter className="text-secondary w-full text-center text-xl"/></button>
            
            <button className="bg-white text-pink-400 shadow-lg font-normal h-10 w-10 items-center justify-center align-center rounded-full outline-none focus:outline-none mr-2" type="button">
            <FaGithub className="text-gray-600 w-full text-center text-xl"/></button>
      ...
      <div className="w-full lg:w-6/12 px-4">
        <div className="flex flex-wrap items-top mb-6">
          ...
          <div className="w-full lg:w-4/12 px-4">
            <span className="block uppercase text-accent text-sm font-semibold mb-2">Other Resources</span>
            <ul className="list-unstyled">
              <li>
    ...
    <div className="flex flex-wrap items-center md:justify-between justify-center">
      <div className="w-full md:w-4/12 px-4 mx-auto text-center">
        <div className="text-sm text-accent font-semibold py-1">
          Copyright © 2023{" "}<span className="text-secondary">Open AI</span> {' '}
         Creative Team
        </div>
      </div>
    </div>

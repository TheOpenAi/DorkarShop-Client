    ...
    <div>
      <div className="text-xl breadcrumbs w-[90%] mx-auto text-secondary">
        <ul>
          ...
          <li>
            <Link to={`/sinlgecategories/${category}`}> Category</Link>
          </li>
          <li>
      ...
      <div className="m-5 bg-white  font-sanserif">
        <div className="container lg:grid lg:grid-cols-2 gap-6 w-[99%] mx-auto">
          ...
          <div>
            ...
            <div className="pt-4 lg:w-[30%] mx-auto w-[50%]">
              <h3 className="text-sm text-gray-800 font-semibold uppercase mb-1">
                Size
              </h3>
              <div className="flex justify-center items-center gap-2">
                <div className="size-selector">
                  ...
                  <label
                    htmlFor="size-xs"
                    className="text-xs border border-gray-200 rounded-sm h-6 w-6 flex items-center justify-center cursor-pointer shadow-sm text-gray-600 hover:bg-primary"
                  >
                    XS
                  </label>
                </div>
        ...
        <div className="container mx-auto lg:p-16">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 mt-10">
            {related.map((product) => (
              <Related product={product} setpicture={setpicture}></Related>
            ))}
          </div>
        </div>
      </div>

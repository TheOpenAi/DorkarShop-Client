...
const Review = () => {
    return (
        ...
        <div>
            <section className="py-10 bg-gray-100 sm:py-16 lg:py-24 md:w-3/4 mx-auto my-20">
                    ...
                    <div className="grid items-center grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 xl:grid-cols-6 sm:gap-x-12 gap-y-12">
                        <div className="lg:col-span-2">
                            <h2 className="text-3xl font-bold leading-tight text-black sm:text-4xl lg:text-5xl lg:leading-tight">
                              <span className='text-secondary'> 1</span> Shop.<br />
                              <span className='text-secondary'>6+</span> years.<br />
                              <span className='text-secondary'>300+</span>  Company Trust Us .<br />
                            </h2>

...
const WhyChoseUs = () => {
    return (
        <div className='w-full bg-accent mt-20 h-auto py-14'>
            <div className='w-3/4 mx-auto grid md:grid-cols-2 lg:grid-cols-4 gap-10'>
                <div className='flex items-center justify-between'>
                    <div className='border-2 rounded-full border-secondary p-3'>

                    <FaTruck className='text-5xl text-orange-500'/>
                    </div>
                    <div className='text-left ml-2'>
                        <h2 className='text-xl text-gray-300 font-bold py-1'>Free Shipping</h2>
                ...
                <div className='flex items-center justify-evenly'>
                    ...
                    <div className='text-left ml-2'>
                        <h2 className='text-xl text-gray-300 font-bold py-1'>24/7 Customer Support</h2>
                ...
                <div className='flex items-center justify-evenly'>
                    ...
                    <FaExchangeAlt className='text-5xl text-orange-500'/>
                    </div>
                    <div className='text-left ml-2'>
                        <h2 className='text-xl text-gray-300 font-bold py-1'>Easy Returns</h2>
                ...
                <div className='flex items-center justify-evenly'>
                    ...
                    <FaCubes className='text-5xl text-orange-500'/>
                    </div>
                    <div className='text-left ml-2'>
                        <h2 className='text-xl text-gray-300 font-bold py-1'>Top Quality</h2>
